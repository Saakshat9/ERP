...
const rows = [
  { id: 1, student: "Ahmed Ali", type: "Transfer", no: "CERT-2024-001", date: "12-06-2025", status: "Issued" },
  { id: 2, student: "Fatima Khan", type: "Bonafide", no: "CERT-2024-002", date: "10-06-2025", status: "Verified" },
]
  ...
  return (
    <DashboardLayout title="Issued Certificates">
      <div className="space-y-6">
          ...
          <CardContent className="pt-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="CERT-..." className="bg-white border-gray-200" />
              </div>
        ...
        <Card>
          <CardHeader className="bg-pink-50 border-b border-pink-100">
            <CardTitle className="text-lg text-gray-800">Issued List</CardTitle>
          </CardHeader>
