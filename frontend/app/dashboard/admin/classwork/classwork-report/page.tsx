...
const rows = [
    { id: 1, title: "Lab Activity 1", classSection: "7-B", date: "12-06-2025", completed: 24, pending: 6 },
    { id: 2, title: "Group Discussion", classSection: "6-A", date: "11-06-2025", completed: 28, pending: 2 },
]
    ...
    return (
        <DashboardLayout title="Classwork Report">
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader className="bg-pink-50 border-b border-pink-100">
                        <CardTitle className="text-lg text-gray-800">Completion Overview</CardTitle>
                    </CardHeader>
