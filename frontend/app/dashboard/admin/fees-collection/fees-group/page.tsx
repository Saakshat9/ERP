...
export default function FeesGroup() {
    ...
    const [groups, setGroups] = useState([
        { id: 1, name: "1 4" },
        { id: 2, name: "1 st class" },
        { id: 3, name: "1 st class B" },
        { id: 4, name: "11 th cs" },
        { id: 5, name: "12 bio" },
        { id: 6, name: "12 class commerce" },
        { id: 7, name: "12 class scince" },
    ])
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setGroups([...groups, { id: Date.now(), name: formData.name }])
        setFormData({ name: "", class: "", description: "" })
        toast.success("Added successfully")
    }

    return (
        <DashboardLayout title="Fee Group">
                        ...
                        <CardHeader className="bg-pink-50 border-b border-pink-100">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <Select>
                                        <SelectTrigger className="w-[180px] bg-white border-gray-200 h-8">
                                            <SelectValue placeholder="Select Fee Groups" />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="g1">Group 1</SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <Button className="bg-blue-900 hover:bg-blue-800 h-8 text-xs">
                                        Re-Create
                                    </Button>
                                </div>
                            </div>
                            <p className="text-xs text-red-500 mt-1">
                                *This will also replicate the previous session&apos;s fee master in the current session.
                            </p>
                        </CardHeader>
                        <CardContent className="pt-6">
