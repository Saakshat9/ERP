...
import { Search, Briefcase, Menu, Plus } from "lucide-react"

const sampleData = [
    { id: 1, class: "1st", section: "A", subject: "Geography", lesson: "Level4", topic: "T1\nT2" },
    { id: 2, class: "1st", section: "A", subject: "Hindi", lesson: "L1", topic: "P\nT" },
    { id: 3, class: "1st year", section: "CSE-2", subject: "MEFA", lesson: "L1 - Unit 2", topic: "MeFa different sales theories" },
    { id: 4, class: "3rd", section: "A", subject: "biology", lesson: "Diversity of Living Organisms", topic: "Morphology of Flowering Plants\nAnatomy of Flowering Plants\nStructural Organisation in Animals" },
    { id: 5, class: "4th", section: "A", subject: "biology", lesson: "importance of sun", topic: "Breathing System" },
    { id: 6, class: "6th", section: "A", subject: "Maths", lesson: "MTH", topic: "SUB MTH" },
]

export default function TopicPage() {
    return (
        <DashboardLayout title="Lesson Planner / Topic">
                    ...
                    <CardHeader className="bg-pink-50/50 border-b pb-4">
                        <CardTitle className="text-base font-bold flex items-center justify-between text-[#1a237e]">
                            <div className="flex items-center gap-2">
                                <Menu className="h-4 w-4" /> Topic List
                            </div>
                                ...
                                <TableBody>
                                    {sampleData.map((item) => (
                                        <TableRow key={item.id} className="hover:bg-muted/50">
                                            ...
                                            <TableCell className="align-top">{item.lesson}</TableCell>
                                            <TableCell className="align-top whitespace-pre-wrap">{item.topic}</TableCell>
