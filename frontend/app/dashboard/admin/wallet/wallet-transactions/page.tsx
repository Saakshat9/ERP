...
const rows = [
    { id: 1, student: "Ansh Sharma", type: "Credit", amount: 500, ref: "TXN-001", date: "12-06-2025" },
    { id: 2, student: "Vanya Patel", type: "Debit", amount: 150, ref: "TXN-002", date: "12-06-2025" },
]
    ...
    return (
        <DashboardLayout title="Wallet Transactions">
            <div className="space-y-6">
                <Card>
                    ...
                    <CardContent className="pt-6 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label>Ref No</Label>
                                <Input placeholder="TXN-..." className="bg-white border-gray-200" />
                            </div>
                            <div className="space-y-2">
                                <Label>Date</Label>
                            ...
                            <div className="space-y-2">
                                <Label>Search</Label>
                                <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Student / Ref" className="bg-white border-gray-200" />
                            </div>
                        </div>
                ...
                <Card>
                    <CardHeader className="bg-pink-50 border-b border-pink-100">
                        <CardTitle className="text-lg text-gray-800">Transactions</CardTitle>
                    </CardHeader>
                    <CardContent className="pt-6">
                        <div className="overflow-x-auto">
                            <Table>
                                ...
                                <TableBody>
                                    {rows
                                        .filter((r) => r.student.toLowerCase().includes(search.toLowerCase()) || r.ref.toLowerCase().includes(search.toLowerCase()))
                                        .map((row) => (
                                            <TableRow key={row.id}>
