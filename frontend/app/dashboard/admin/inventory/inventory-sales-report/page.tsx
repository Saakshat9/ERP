...
export default function InventorySalesReportPage() {
    return (
        <DashboardLayout title="Inventory Sales Report">
            <div className="space-y-6">
                ...
                <Card className="shadow-sm border-t-4 border-t-[#1a237e]">
                    <CardHeader className="bg-pink-50/50 border-b pb-4">
                        <CardTitle className="text-base font-bold flex items-center gap-2 text-[#1a237e]">
                            <List className="h-4 w-4" /> Inventory Sales Report List
                        </CardTitle>
                    </CardHeader>
                        ...
                        <div className="rounded-md border">
                            <Table>
                                <TableHeader className="bg-pink-50/50">
                                    <TableRow>
                                        <TableHead className="font-bold text-[#1a237e] whitespace-nowrap">CATEGORY</TableHead>
                                        <TableHead className="font-bold text-[#1a237e] whitespace-nowrap">SUB CATEGORY</TableHead>
                                    ...
                                    {[
                                        {
                                            ...
                                            sub: "boys uniform",
                                            item: "uniform",
                                            to: "Test 1002 SJ User (1002)",
                                            date: "28-10-2025",
                                            by: "Nlet Initiatives LLP Support",
                                            qty: "1",
                                            amt: "400"
                                        }
                                    ].map((row, i) => (
                                        <TableRow key={i} className="hover:bg-muted/50">
                                            ...
                                            <TableCell className="max-w-[150px]">{row.by}</TableCell>
