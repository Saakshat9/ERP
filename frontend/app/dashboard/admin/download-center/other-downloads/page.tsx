...
import { Search, Download, File, Menu } from "lucide-react"

const sampleData = [
    { id: 1, title: "School Rules", type: "Other Download", date: "01-04-2024", forStaff: "Yes", class: "All", subject: "" },
    { id: 2, title: "Holiday List", type: "Other Download", date: "01-04-2024", forStaff: "Yes", class: "All", subject: "" },
]
                    ...
                    <CardHeader className="bg-pink-50/50 border-b pb-4">
                        <CardTitle className="text-base font-bold flex items-center justify-between text-[#1a237e]">
                            <div className="flex items-center gap-2">
                                <Menu className="h-4 w-4" /> Other Downloads List
                            </div>
                        </CardTitle>
                    </CardHeader>
