...
const sampleData = [
    ...
    },
    {
        ...
        subDate: "24-10-2025",
        evalDate: "",
        description: "Biology Classwork 23-10-25 to 24-10-25",
        createdBy: "Super",
    },
    {
        id: 3,
...
export default function AddClassworkPage() {
    return (
                            ...
                            <div className="space-y-2">
                                ...
                                <Select>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="KG 1st">KG 1st</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                    ...
                    <CardHeader className="bg-pink-50/50 border-b pb-4">
                        <CardTitle className="text-base font-bold flex items-center justify-between text-[#1a237e]">
                            <div className="flex items-center gap-2">
                                <Menu className="h-4 w-4" /> Classwork List
                            </div>
