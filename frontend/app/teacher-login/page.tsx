...
import { BookOpen, Mail, KeyRound, AlertCircle, ArrowRight, ArrowLeft } from "lucide-react"
...
export default function TeacherLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 via-green-50 to-emerald-50 p-4 relative">
      {/* Back Button */}
      <button
        onClick={() => router.back()}
