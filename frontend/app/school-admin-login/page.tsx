...
export default function SchoolAdminLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-blue-50 to-sky-50 p-4 relative">
      {/* Back Button */}
      <button
        onClick={() => router.back()}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mt-6 text-sm text-muted-foreground">
          <p>© 2024 School ERP. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
